...
const PROJECTS = [
  ...
  { g:'wins', cover:'thermal', slug:'datacenter-thermal-twin', title:'Datacenter Thermal Twin', when:'Yconic × NVIDIA · 2nd, $4,000',
    stack:'ESP32 · Express API · OSRM · wavefront routing · Leaflet',
    d:'A thermal packet-switching twin: an ESP32 runs a closed loop — pull routing commands, apply heat generation at sources and draw at sinks, transfer along the chosen route, drift toward ambient, push telemetry back. I built the API that closes that loop. The map layer solves routes with OSRM and a wavefront search, and you can paint road blockages that force it to re-route live. <em>Treating waste heat as an input to something rather than a problem to vent.</em>',
    stats:[['placed','2nd'],['prize','$4,000'],['built in','one weekend'],['my part','the API']],
    links:[['Datlightning/HeatRouterTVG','https://github.com/Datlightning/HeatRouterTVG','private']] },

  { g:'wins', cover:'chart', slug:'escalation-sentiment-dashboard', title:'Escalation Sentiment Dashboard', when:'TVG Hackathon · 2nd, $3,000',
